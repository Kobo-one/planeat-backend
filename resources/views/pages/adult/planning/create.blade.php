...
@section('header')
    @include('partials.adult.smallheader',['back'=>null, 'title'=> $readableDate,'rightUrl'=>'','icon' => '','search'=>true])
@endsection
        ...
        <div class="masonry flex flex-column flex-wrap">
            ...
            @foreach($recipes as $recipe)
                <a href="{{route('planning_show',[$date,$recipe->id])}}">
                    <div class="panel masonry__item panel--masonry" style="background-image: url({{asset($recipe->img)}})">
