...
@section('header')
    @include('partials.adult.header',['back'=>false, 'title'=> '','rightUrl'=>route('member_index'),'icon' => Auth::user()->currentMember()->avatar->img,'search'=>false])
@endsection
...
{{--        </div>--}}
        ...
        <div class="grid grid--2-col dashboard__items">
            ...
            <a href="{{route('quest_rating',now()->toDateString())}}" class="grid__item selection__item panel"><img src="dashboard__img" alt="After dinner icon"><h2>After dinner</h2><p>Have your kids eaten well or not?</p></a>
